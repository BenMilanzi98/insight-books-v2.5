...
import { retireBannedGlAccountsForTenant } from './retireBannedGlAccounts.js';
...
export async function runCanonicalCoaMigrationsPhase2(tenantId, tx = prisma) {
  ...
  // Soft-merge banned codes (1120 Petty Cash → 1110 Cash Main) for every tenant.
  await retireBannedGlAccountsForTenant(tenantId, tx);
}
