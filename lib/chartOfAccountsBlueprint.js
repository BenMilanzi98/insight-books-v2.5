...
export const CHART_OF_ACCOUNTS_BLUEPRINT = [
  ...
  { code: '5110', name: 'Cost of Goods Sold', type: 'Expense', parentCode: '5100', subtype: 'Cost of Sales', isSystem: true, description: 'Cost of inventory sold (perpetual). Purchases remain on the balance sheet until sold.' },
