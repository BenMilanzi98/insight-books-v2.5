 ...
 * Posting conventions: revenue stored as accountType "Income"; **all cash GL postings use 1110** (Cash - Main Account);
 * petty cash 1120; bank / mobile / wallet / POS use **1130-01** … only (bare **1130** is rollup-only).
 *
