 ...
 *
 * Posting conventions: cash GL uses 1110 only (1120 Petty Cash is retired); Malawi banks 1131–1138 under 1130; mobile money 1140/1141; POS clearing 1145.
 */
...
export const CHART_OF_ACCOUNTS_BLUEPRINT = [
  ...
  { code: '1110', name: 'Cash - Main Account', type: 'Asset', parentCode: '1100', subtype: 'Current Asset', isSystem: true, description: 'Primary cash on hand — the sole cash GL account for all cash postings.' },
  ...
  { code: '3190', name: 'Opening Balance Equity', type: 'Equity', parentCode: '3100', subtype: 'Equity', isSystem: true, description: 'System counter-account for opening balances during onboarding. Posted only via opening-balance service — not for manual journals.', acceptsNewTransactions: true },
  ...
  { code: '5100', name: 'Cost of Goods', type: 'Expense', parentCode: '5000', subtype: 'Group', isSystem: true },
  { code: '5110', name: 'Cost of Goods Sold', type: 'Expense', parentCode: '5100', subtype: 'Cost of Goods', isSystem: true, description: 'Cost of inventory sold (perpetual). Purchases remain on the balance sheet until sold.' },
  { code: '5120', name: 'Purchase Returns & Discounts', type: 'Expense', parentCode: '5100', subtype: 'Cost of Goods', isSystem: true, normalBalance: 'Credit' },
  { code: '5130', name: 'Freight & Import Costs', type: 'Expense', parentCode: '5100', subtype: 'Cost of Goods', isSystem: true, description: 'Inbound freight and import logistics tied to inventory cost.' },
  { code: '5140', name: 'Direct Labour', type: 'Expense', parentCode: '5100', subtype: 'Cost of Goods', isSystem: true },
  { code: '5150', name: 'Subcontractor Costs', type: 'Expense', parentCode: '5100', subtype: 'Cost of Goods', isSystem: true },
  { code: '5160', name: 'Project Materials', type: 'Expense', parentCode: '5100', subtype: 'Cost of Goods', isSystem: true },
  { code: '5170', name: 'Packaging for Resale', type: 'Expense', parentCode: '5100', subtype: 'Cost of Goods', isSystem: true, description: 'Boxes, bags, labels and packing materials that form part of goods sold.' },
  { code: '5180', name: 'Customs Duty & Clearing', type: 'Expense', parentCode: '5100', subtype: 'Cost of Goods', isSystem: true, description: 'Import duty, clearing agents, and border charges on inventory.' },
