 ...
 * Includes COGS detail leaves (standard postings use **5110 Purchases**, not the
 * **5000 Expenses** or **5100 Cost of Sales** structural rollups).
 *
...
export async function getCogsAccountIdsForExpenseRegister(prisma, tenantScope) {
  ...
  /** Standard chart: Cost of Sales detail accounts **5110–5199**. */
