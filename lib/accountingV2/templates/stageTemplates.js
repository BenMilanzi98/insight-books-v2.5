...
async function buildCustomerPaymentDraft({ command, source, resolvePurpose }) {
  const currency = command.currency;
  ...
  return draftBase({
    ...
    description: `Customer payment ${source.id}`,
  });
}
...
registerTemplate({
  ...
  description: 'Dr Cash/Bank/Mobile Money, Cr Accounts Receivable.',
