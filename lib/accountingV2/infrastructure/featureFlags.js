...
const DEFAULT_ENABLED_FLAGS = new Set([
  BANK_RECON_FLAGS.ENABLED,
  BANK_RECON_FLAGS.AUTO_MATCH,
  CLOSE_FLAGS.ENABLED,
  ...
  // Phase 8 — financial calendar / periods (pages are live in the product shell)
  PERIOD_FLAGS.CALENDAR_V2,
  PERIOD_FLAGS.PERIODS_V2,
  PERIOD_FLAGS.RESOLVER_V2,
  PERIOD_FLAGS.CLOSE_WORKFLOW,
  PERIOD_FLAGS.REOPEN_WORKFLOW,
  PERIOD_FLAGS.CLOSE_CHECKLIST_V2,
  PERIOD_FLAGS.CLOSE_SNAPSHOTS,
  PERIOD_FLAGS.INTEGRITY_MONITORING,
  // Phase 10 — bank reconciliation
  BANK_RECON_FLAGS.ENABLED,
  BANK_RECON_FLAGS.AUTO_MATCH,
  BANK_RECON_FLAGS.PERIOD_CLOSE_FEED,
  BANK_RECON_FLAGS.OFX_IMPORT,
  // Phase 11 — equity management
  EQUITY_FLAGS.ENABLED,
  EQUITY_FLAGS.OWNERS,
  EQUITY_FLAGS.SHAREHOLDERS,
  EQUITY_FLAGS.SHARE_CAPITAL,
  EQUITY_FLAGS.CONTRIBUTIONS,
  EQUITY_FLAGS.DRAWINGS,
  EQUITY_FLAGS.DIVIDENDS,
  EQUITY_FLAGS.RECONCILIATION,
  EQUITY_FLAGS.SNAPSHOTS,
  EQUITY_FLAGS.OWNERSHIP_REGISTER,
  EQUITY_FLAGS.LEGACY_READ,
