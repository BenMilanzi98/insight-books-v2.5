...
/**
 * Run `fn` in a transaction when `db` is a root Prisma client.
 * Interactive transaction clients (from prisma.$transaction) do not expose
 * `$transaction` — run inline on the same client instead.
 */
