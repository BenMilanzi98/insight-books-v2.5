...
const API_ROUTE_RULES = [
  ...
  { prefix: '/api/desktop-local', anyOf: [...POS_SALES, 'invoices.view', 'invoices.create', 'clients.view', 'inventory.view', 'payments.view'] },
  ...
  { prefix: '/api/capital-account', anyOf: ['accounts.view', 'accounts.update', 'reports.view', 'equity.view'] },
