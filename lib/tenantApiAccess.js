...
const API_ROUTE_RULES = [
  ...
  { prefix: '/api/clients', anyOf: ['clients.view', 'clients.create', 'clients.update', 'clients.delete'] },
  ...
  { prefix: '/api/stock', anyOf: ['inventory.view', 'inventory.create', 'inventory.update', 'inventory.delete'] },
  { prefix: '/api/inventory', anyOf: ['inventory.view', 'inventory.create', 'inventory.update', 'inventory.delete'] },
  ...
  { prefix: '/api/accounts', anyOf: ['accounts.view', 'accounts.create', 'accounts.update', 'accounts.delete'] },
  { prefix: '/api/chart-of-accounts', anyOf: ['accounts.view', 'accounts.create', 'accounts.update', 'accounts.delete'] },
  ...
  { prefix: '/api/tax', anyOf: ['tax.view', 'tax.update'] },
  { prefix: '/api/tax-types', anyOf: ['tax.view', 'tax.update'] },
  { prefix: '/api/tax-accounts', anyOf: ['tax.view', 'tax.update'] },
  ...
  { prefix: '/api/eis', anyOf: ['reports.view', 'invoices.view', 'inventory.view'] },
  ...
  { prefix: '/api/payment-accounts', anyOf: ['payments.view', 'payments.create', 'payments.update'] },
  { prefix: '/api/payment-methods', anyOf: ['payments.view', 'payments.update'] },
  ...
  { prefix: '/api/products', anyOf: ['inventory.view', 'inventory.update'] },
  { prefix: '/api/receivables', anyOf: ['invoices.view', 'reports.view'] },
  { prefix: '/api/services', anyOf: ['inventory.view', 'inventory.update'] },
  ...
  { prefix: '/api/settings/tax', anyOf: ['tax.view', 'tax.update', 'settings.update'] },
  { prefix: '/api/settings/tax-defaults', anyOf: ['tax.view', 'tax.update', 'settings.update'] },
  { prefix: '/api/stock-by-branch', anyOf: ['inventory.view'] },
  { prefix: '/api/stock-transfers', anyOf: ['inventory.view', 'inventory.update'] },
  { prefix: '/api/tenant', anyOf: ['system.view', 'system.update', 'system.switchTenant'] },
  { prefix: '/api/transactions/reversals', anyOf: ['journalEntries.view'] },
  { prefix: '/api/transactions/reverse', anyOf: ['journalEntries.update'] },
  { prefix: '/api/uploads', anyOf: ['system.view', 'users.view'] },
];
