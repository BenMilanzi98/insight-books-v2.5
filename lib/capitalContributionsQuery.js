...
function mapFromV2Journal(journal, creditAccountIds) {
  ...
  return {
    ...
    amount: lineAmount(creditLine.creditAmount),
    type,
    reference: journal.sourceId || journal.referenceNumber || journal.journalNumber || '',
    journalId: journal.id,
    isReversed: Boolean(journal.reversedByJournalId) || journal.reversalStatus === 'REVERSED',
