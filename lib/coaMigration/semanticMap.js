...
export function semanticMapTarget({ accountName, bucket }) {
  ...
  const rules = [
    { bucket: 'Expense', re: /\btravel\b|transport|commuting|mileage/i, code: '5340' },
    { bucket: 'Expense', re: /\bdomestic travel\b/i, code: '5344' },
    { bucket: 'Expense', re: /\binternational travel\b/i, code: '5346' },
    { bucket: 'Expense', re: /accommodation|hotel|lodging/i, code: '5343' },
    { bucket: 'Expense', re: /fuel|vehicle running|petrol|diesel(?!.*generator)/i, code: '5341' },
    { bucket: 'Expense', re: /\bwater\b|sanitation|sewer/i, code: '5316' },
    { bucket: 'Expense', re: /\belectricity\b|escom|power bill/i, code: '5311' },
    { bucket: 'Expense', re: /internet|telecom|phone bill|airtime|data bundle/i, code: '5315' },
    ...
    { bucket: 'Expense', re: /grni|goods received not invoiced/i, code: '2115' },
    { bucket: 'Asset', re: /cash in hand|till float|petty float|petty cash/i, code: '1110' },
    ...
    { bucket: 'Liability', re: /\bvat payable\b|\bvat control\b/i, code: '2120' },
    { bucket: 'Liability', re: /salaries payable|payroll payable/i, code: '2190' },
    { bucket: 'Liability', re: /employee payable|staff reimbursement/i, code: '2170' },
