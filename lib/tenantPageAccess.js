...
const ROUTE_RULES = [
  ...
  { prefix: '/financial-setup/opening-balances', anyOf: ['accounts.update', 'system.update'] },
  { prefix: '/branches/migrate', anyOf: ['branches.update', 'system.update'] },
  ...
  { prefix: '/setup', anyOf: ['system.update', 'system.view'] },
