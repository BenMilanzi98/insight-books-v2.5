...
/** @type {RouteRule[]} */
const ROUTE_RULES = [
  { prefix: '/stock/transactions', anyOf: ['inventory.view', 'stock.view'] },
  { prefix: '/stock/low-stock', anyOf: ['inventory.view', 'stock.view'] },
  { prefix: '/payments/management', anyOf: ['payments.view'] },
  { prefix: '/purchases/suppliers', anyOf: ['suppliers.view', 'purchases.view'] },
  { prefix: '/suppliers/reports', anyOf: ['suppliers.view', 'reports.view'] },
  { prefix: '/suppliers', anyOf: ['suppliers.view', 'purchases.view'] },
  { prefix: '/hr/employees', anyOf: ['hr.view'] },
  { prefix: '/hr/attendance', anyOf: ['hr.view'] },
  { prefix: '/hr/performance', anyOf: ['hr.view'] },
  { prefix: '/hr/payroll', anyOf: ['payroll.view', 'hr.view'] },
  { prefix: '/hr/benefits', anyOf: ['hr.view'] },
  { prefix: '/hr/pension', anyOf: ['payroll.view', 'hr.view'] },
  { prefix: '/hr/gratuity', anyOf: ['payroll.view', 'hr.view'] },
  { prefix: '/hr/advances', anyOf: ['payroll.view', 'hr.view'] },
  { prefix: '/hr/reports', anyOf: ['hr.view', 'reports.view'] },
  { prefix: '/capital-account/transfers', anyOf: ['reports.view', 'accounts.view'] },
  { prefix: '/financial-setup/opening-balances', anyOf: ['openingBalances.view', 'openingBalances.manage', 'accounts.update', 'system.update'] },
  ...
  { prefix: '/capital-account', anyOf: ['reports.view', 'accounts.view', 'equity.view', 'equity.viewDashboard'] },
  { prefix: '/equity-management', anyOf: ['reports.view', 'accounts.view', 'equity.view', 'equity.viewDashboard'] },
  ...
  { prefix: '/reports-v2', anyOf: ['reports.view'] },
  ...
  { prefix: '/financial-planning', anyOf: ['budgets.view', 'financialPlanning.view'] },
  ...
  { prefix: '/rentals', anyOf: ['rentals.view', 'invoices.view', 'rentals.create'] },
  { prefix: '/tax-types', anyOf: ['tax.view', 'taxManagement.view', 'accounting.view', 'reports.view'] },
  {
    prefix: '/tax-management',
    anyOf: ['tax.view', 'taxManagement.view', 'accounting.view', 'reports.view'],
  },
  { prefix: '/tax-rules', anyOf: ['tax.view', 'taxManagement.view'] },
  { prefix: '/tax-accounts', anyOf: ['tax.view', 'taxManagement.view', 'accounts.view'] },
  { prefix: '/tax', anyOf: ['tax.view', 'taxManagement.view'] },

  { prefix: '/eis', anyOf: ['reports.view', 'invoices.view'] },
  {
    prefix: '/settings/integrations/mra-eis',
    anyOf: ['settings.view', 'eis.availabilityView', 'eis.readinessView', 'system.view'],
  },
  ...
  { prefix: '/setup', anyOf: ['system.update', 'system.view', 'settings.view', 'settings.update'] },
