...
export const permissionModules = {
    ...
    system: { actions: ['view', 'update', 'switchTenant'] },
    ...
    rentals: { actions: ['create', 'view', 'update', 'delete', 'export'] },
    // Used by UI / guards (previously missing from the map; Owner/Admin bypass still applied on server).
    settings: { actions: ['view', 'update'] },
    accounting: { actions: ['view', 'manage', 'export'] },
    suppliers: { actions: ['create', 'view', 'update', 'delete', 'export'] },
    leave: { actions: ['create', 'view', 'update', 'delete', 'approve', 'export'] },
    /** Parallel to `inventory.*`; many screens still check `stock.*` (see `permissionAliases`). */
    stock: { actions: ['create', 'view', 'update', 'delete', 'adjust', 'export'] },
  };
