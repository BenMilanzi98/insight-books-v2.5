...
/**
 * True when a rounded MWK amount should be shown on reports (non-zero after cent rounding).
 * @param {unknown} amount
 * @param {number} [tolerance=MONEY_TOLERANCE_CENT]
 */
export function isNonZeroMoneyAmount(amount, tolerance = MONEY_TOLERANCE_CENT) {
  return Math.abs(roundMoney(amount)) >= tolerance;
}
