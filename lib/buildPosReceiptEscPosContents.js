/**
 * Receipt payload for raw 80mm/58mm thermal printing with @madrimov/electron-pos-printer
...
/**
 * @param {{ sale: object, tenantSettings: object | null, taxData: object, paperWidth?: 58 | 80 }} args
 * @returns {{ paperWidth: number, contents: object[], meta: { saleId: string, saleNumber: string } }}
 */
export function buildPosReceiptEscPosContents({ sale, tenantSettings, taxData, paperWidth = 80 }) {
  const normalizedPaperWidth = Number(paperWidth) === 58 ? 58 : 80;
