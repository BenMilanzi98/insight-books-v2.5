/**
 * Receipt payload for raw 80mm thermal printing with @madrimov/electron-pos-printer
...
/**
 * @param {{ sale: object, tenantSettings: object | null, taxData: object }} args
 * @returns {{ paperWidth: number, contents: object[], meta: { saleId: string, saleNumber: string } }}
 */
export function buildPosReceiptEscPosContents({ sale, tenantSettings, taxData }) {
