...
export async function generateIncomeStatementFromAccounts(
  ...
  const result = {
    ...
    metadata: {
      ...
      dataSource:
        'Revenue and COGS system-generated. COGS from posted GL (COGS accounts) when available, else sale/invoice cost estimates; excludes shipping. Operating expenses roll up to Chart of Accounts main lines (expense tracking + payroll + depreciation). Same logic for dashboard, Excel, PDF.',
