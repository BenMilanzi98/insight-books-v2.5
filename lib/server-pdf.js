...
function generateInvoiceHtml(invoice, style, primaryColor, branding, showLogo, showFooter) {
  ...
  const formattedTax = formatCurrency(invoice.taxAmount);
  ...
  const itemsHtml = invoice.items?.map(item => {
    ...
    const formattedAmount = formatCurrency(item.quantity * item.unitPrice);
  ...
  // Footer
  const footerHtml = showFooter && branding?.emailFooter ? 
    `<p style="margin-top: 20px; font-size: 12px; color: #666;">${branding.emailFooter}</p>` : '';
            ...
            <table style="width: 100%; border-collapse: collapse;">
              <thead>
                <tr style="background-color: ${primaryColor}15;">
                  ...
                  <th style="padding: 10px; text-align: right; font-size: 12px; text-transform: uppercase;">Rate</th>
          ...
          <table style="width: 100%; border-collapse: collapse; margin-bottom: 30px;">
            <thead>
              <tr>
                ...
                <th style="padding-bottom: 10px; text-align: right; font-size: 12px; font-weight: normal; color: #71717a; text-transform: uppercase;">Rate</th>
                ...
                <th style="padding-bottom: 10px; text-align: right; font-size: 12px; font-weight: normal; color: #71717a; text-transform: uppercase;">Amount</th>
              </tr>
            </thead>
            <tbody>
              ${itemsHtml}
          ...
          <table style="width: 100%; border-collapse: separate; border-spacing: 0; margin-bottom: 30px;">
            <thead>
              <tr style="background-color: #f3f4f6;">
                ...
                <th style="border-bottom: 2px solid #e5e7eb; padding: 10px; text-align: right; font-size: 12px; color: #6b7280; text-transform: uppercase;">Rate</th>
                ...
                <th style="border-bottom: 2px solid #e5e7eb; padding: 10px; text-align: right; font-size: 12px; color: #6b7280; text-transform: uppercase;">Amount</th>
              </tr>
            </thead>
            <tbody>
              ${itemsHtml}
