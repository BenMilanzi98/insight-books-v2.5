 ...
 * @param {boolean} applyNPS - Whether to apply NPS deduction (default: true)
 * @returns {Object} Complete payroll calculation with all deductions
 */
export function calculateMalawiPayroll(payrollData, applyPAYE = false, applyNPS = true) {
  const {
    basicSalary = 0,
    allowances = {},
    otherDeductions = {},
  ...
  const npsCalculation = applyNPS ? calculateNPS(totalGrossPay) : { employeeAmount: 0, employerAmount: 0, totalAmount: 0, employeeRate: 0, employerRate: 0, totalRate: 0 };
