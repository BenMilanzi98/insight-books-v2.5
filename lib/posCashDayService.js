    ...
    if (mode === 'reopen' && closedSnapshot) {
      await client.posCashDay.update({
        ...
        data: {
          ...
          systemCashAccountId: closedSnapshot.systemCashAccountId,
          tillFloatAccountId: closedSnapshot.tillFloatAccountId,
          openedAt: closedSnapshot.openedAt,
          openedById: closedSnapshot.openedById,
          closedAt: closedSnapshot.closedAt,
          closedById: closedSnapshot.closedById,
...
export async function openPosCashDay({
  ...
  if (openingBalance > 0 && cashPart > 0 && !cashCoaId) {
