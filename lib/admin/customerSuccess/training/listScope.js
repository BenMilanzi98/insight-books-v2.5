/**
 * Shared portfolio / tenant list scope for training lists.
...
export async function resolveTrainingListScope(prisma, admin, args = {}) {
  ...
  if (!access.canView && !access.canManageCases && !access.isSuperAdmin) {
    return { ok: false, reason: 'training_scope_forbidden', forbidden: true };
  }
