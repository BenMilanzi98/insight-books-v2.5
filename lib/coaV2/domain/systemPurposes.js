...
export const SYSTEM_ACCOUNT_PURPOSES = Object.freeze({
  ...
  POS_TILL_FLOAT: {
    ...
    legacyCode: '1112',
    notes:
      'Internal POS till float only (hidden from chart/pickers). Cash selection and sales always use 1110.',
  },
  /** @deprecated Alias of CASH_ON_HAND — Petty Cash GL 1120 is retired; maps to 1110. */
  PETTY_CASH: { categories: [ASSET], behaviours: [POSTING], normalBalance: DEBIT, subTypes: [AccountSubType.CURRENT_ASSET], legacyCode: '1110' },
  ...
  REPAIRS_AND_MAINTENANCE: { categories: [EXPENSE], behaviours: [POSTING], normalBalance: DEBIT, legacyCode: '5380' },
