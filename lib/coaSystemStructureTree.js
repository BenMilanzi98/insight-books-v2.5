 ...
 * Rows in `COA_STRUCTURE_CODES_WITH_SERVER_FOLDED_BUCKETS` use API totals only (bucket amounts already folded server-side).
...
export function structureRowDisplayBalance(matches, nodeCode, buckets = {}) {
  ...
  if (COA_STRUCTURE_CODES_WITH_SERVER_FOLDED_BUCKETS.has(code)) return base;
