 ...
 */
async function getAccountBalanceAsOfDate(accountId, tenantId, asOfDate, accountCode = null) {
  ...
  try {
    const details = await getAccountBalanceDetails(accountId, tenantId, asOfDate, prisma);
 ...
 */
export async function generateBalanceSheetFromAccounts(tenantId, asOfDate, companyName = 'Company', logoUrl = null) {
