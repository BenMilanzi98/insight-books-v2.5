    ...
    try {
      ...
      if (user) {
        ...
        try {
          ...
          if (extended) {
            if (extended.userBranches) user.userBranches = extended.userBranches;
            if (extended.tenant) user.tenant = extended.tenant;
          }
        } catch (_) {
          // userBranches or tenant branch fields not in schema
        }
      }
