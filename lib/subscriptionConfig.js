...
export const SUBSCRIPTION_PLANS = {
  ...
  ONE_YEAR: {
    ...
    popular: true,
    highlight: true,
    savings: 'Save MK60,000 with annual plan'
  },
...
export function getPaidSubscriptionPlans() {
  return [SUBSCRIPTION_PLANS.ONE_MONTH, SUBSCRIPTION_PLANS.THREE_MONTHS, SUBSCRIPTION_PLANS.ONE_YEAR];
}
 ...
 * @param {string} plan - Plan ID ('1month', '3months', '1year')
