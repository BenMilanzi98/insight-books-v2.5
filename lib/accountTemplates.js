...
export const accountTemplates = {
  retail: {
    ...
    accounts: [
      ...
      { code: "5310", name: "Utilities Expense", type: "Expense", normalBalance: "Debit" },
  ...
  manufacturing: {
    ...
    accounts: [
      ...
      { code: "1000", name: "Cash", type: "Asset", normalBalance: "Debit" },
      { code: "1020", name: "Bank Account", type: "Asset", normalBalance: "Debit" },
      // Blueprint: AR=1200; inventory under 1300 (1310/1320/1330 detail)
      { code: "1200", name: "Accounts Receivable", type: "Asset", normalBalance: "Debit" },
      { code: "1300", name: "Inventory", type: "Asset", normalBalance: "Debit" },
      { code: "1310", name: "Raw Materials Inventory", type: "Asset", normalBalance: "Debit" },
      { code: "1320", name: "Work in Process Inventory", type: "Asset", normalBalance: "Debit" },
      { code: "1330", name: "Finished Goods Inventory", type: "Asset", normalBalance: "Debit" },
      ...
      { code: "5250", name: "Manufacturing Overhead", type: "Expense", normalBalance: "Debit" },
  ...
  nonprofit: {
    ...
    accounts: [
      ...
      { code: "5250", name: "Fundraising Expenses", type: "Expense", normalBalance: "Debit" },
      { code: "5200", name: "Salaries & Wages", type: "Expense", normalBalance: "Debit" },
