...
export async function getPostedGlSurvivorTotalsForPeriod({
  ...
  // Fresh-books: Transaction archive is unused — JournalEntry ACCOUNTING_V2 only.
      ...
      imbalanceDetails:
        Math.abs(difference) >= 0.01
          ? {
              ...
              totalCredits,
              difference,
              hint: 'Review unbalanced posted transactions or manual journals in the GL audit.',
            }
          : null,
    },
  };
