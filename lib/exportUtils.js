...
function compareStockMovementProductsForExport(a, b) {
 ...
 * Products are listed A–Z by name (then SKU).
 */
const prepareStockMovementExport = (data) => {
  ...
  const productMovementsSorted = [...(data.productMovements || [])].sort(
    compareStockMovementProductsForExport
  );

  productMovementsSorted.forEach((pm) => {
