 ...
 * - **Cash** → **1110 Cash - Main Account** only (single cash ledger; no postings to 1111–1119 registers).
 * - **Bank**, **Mobile Money**, **Wallet**, **POS Terminal** → **1130-01 … 1130-99** under **1130** (bare **1130** is rollup-only, no GL postings).
 */
 ...
 * - **Cash**: linked to legacy **1111–1119** (repoint to **1110**). **1110** is already correct.
 * - **Bank / …**: linked to bare **1130** (repoint to **1130-xx**).
 * @param {{ accountCode?: string|null; code?: string|null; id?: string|null } | null} linkedAccount
...
/**
 * PaymentAccount rows whose `coaAccountId` should be updated (Cash off 1111–1119 → 1110; Bank off bare 1130 → 1130-xx).
 * Run {@link ensurePaymentAccountCoaLink} on each.
...
/**
 * @deprecated Retained for one-off data migrations only; Cash payment links use **1110** directly.
