...
import { HEALTH_SECTIONS, isHealthSectionActive } from '@/lib/admin/healthNav';
import { cn } from '@/lib/utils';

export default function HealthSectionNav({ className }) {
  ...
  return (
    <nav
      ...
      aria-label={t('admin-pages.customerHealth.sectionNavLabel')}
    >
      {HEALTH_SECTIONS.map((section) => {
        const active = isHealthSectionActive(pathname, section);
