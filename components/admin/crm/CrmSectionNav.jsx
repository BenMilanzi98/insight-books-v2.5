...
import { CRM_SECTIONS, isCrmSectionActive } from '@/lib/admin/crmNav';
...
export default function CrmSectionNav({ className }) {
  ...
  return (
    <nav
      ...
      aria-label={t('admin-pages.crm.sectionNavLabel')}
    >
      {CRM_SECTIONS.map((section) => {
        const active = isCrmSectionActive(pathname, section);
