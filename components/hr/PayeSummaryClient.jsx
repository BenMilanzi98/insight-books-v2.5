        ...
        {(summary.totalPayeRemitted != null || summary.totalPayeOutstanding != null) && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-6">
            <div className="bg-green-50 border border-green-200 rounded-xl p-4">
              ...
              <p className="text-xl font-bold text-green-900">{formatCurrency(summary.totalPayeRemitted)}</p>
            </div>
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
              <p className="text-xs font-medium text-yellow-700">PAYE outstanding (MRA)</p>
              <p className="text-xl font-bold text-yellow-900">{formatCurrency(summary.totalPayeOutstanding)}</p>
            </div>
          </div>
        )}
