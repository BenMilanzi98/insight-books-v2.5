...
/// Stock movement types accepted by the offline queue and v2.0 API.
...
class StockMovementOfflineQueue {
  static const _queueKey = 'stock_movement_offline_queue_v1';
  static const int defaultMaxRetries = 3;

  final int maxRetries;

  StockMovementOfflineQueue({this.maxRetries = defaultMaxRetries});
