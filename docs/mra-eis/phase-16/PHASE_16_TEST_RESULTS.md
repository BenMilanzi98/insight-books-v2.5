...
`npx vitest run test/mraEis.phase16.offline.test.js` — **9/9 passed** (contracts, certification/capability, connectivity/clock, signer/sequence/envelope, queue/upload/quarantine/limits, typed errors).
