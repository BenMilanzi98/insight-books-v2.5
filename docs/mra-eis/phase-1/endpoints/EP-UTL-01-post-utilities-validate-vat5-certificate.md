# EP-UTL-01: Validates the authenticity and validity of a VAT 5 Certificate.
...
## Purpose
Validates the authenticity and validity of a VAT 5 Certificate.
...
- Schema: `#/components/schemas/Vat5CertificateValidationRequest`
