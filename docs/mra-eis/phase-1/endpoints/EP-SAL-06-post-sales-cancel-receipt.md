# EP-SAL-06: Creates a void request for an existing invoice (receipt).
...
## Purpose
Creates a void request for an existing invoice (receipt).
...
- Schema: `#/components/schemas/VoidReceiptCreateDto`
