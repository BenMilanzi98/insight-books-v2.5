# EP-UTL-08: Retrieves the latest products for a terminal site
...
## Purpose
Retrieves the latest products for a terminal site
...
- Schema: `#/components/schemas/InventoryRequest`
