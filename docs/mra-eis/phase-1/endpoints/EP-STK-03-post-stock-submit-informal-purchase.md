# EP-STK-03: This method saves stocks that were purchased from traders not in EIS. This is subject to approval.
...
## Purpose
This method saves stocks that were purchased from traders not in EIS. This is subject to approval.
...
- Schema: `#/components/schemas/GoodsReceivingModel`

## Response schema
- Declared HTTP responses: 200, 202, 404
...
OpenAPI HTTP codes: 200, 202, 404. Application error catalogue: ERROR_CODE_CATALOGUE.md + guide error_codes.
