# EP-UTL-02: Retrieves the blocking message for a terminal, if it is currently blocked
...
## Purpose
Retrieves the blocking message for a terminal, if it is currently blocked
...
- Schema: `#/components/schemas/TerminalBlockRequest`
