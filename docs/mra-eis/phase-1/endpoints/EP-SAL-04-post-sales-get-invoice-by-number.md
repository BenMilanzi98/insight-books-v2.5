# EP-SAL-04: Fetches a submitted invoice by invoice number, including validation URL and levy details.
...
## Purpose
Fetches a submitted invoice by invoice number, including validation URL and levy details.
...
- Schema: `#/components/schemas/InvoiceLookupRequest`

## Response schema
- Declared HTTP responses: 200, 400, 401, 404
...
OpenAPI HTTP codes: 200, 400, 401, 404. Application error catalogue: ERROR_CODE_CATALOGUE.md + guide error_codes.
