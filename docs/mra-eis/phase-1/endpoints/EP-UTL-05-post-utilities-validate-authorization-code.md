# EP-UTL-05: This checks the authenticity and validity of an authorization code
...
## Purpose
This checks the authenticity and validity of an authorization code
...
- Schema: `#/components/schemas/UnValidatedAuthorizationCode`

## Response schema
- Declared HTTP responses: 200, 400, 503
...
OpenAPI HTTP codes: 200, 400, 503. Application error catalogue: ERROR_CODE_CATALOGUE.md + guide error_codes.
