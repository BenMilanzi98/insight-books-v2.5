# EP-STK-04: Submits a stock adjustment request (Increase or Decrease) for a given product barcode.
...
## Purpose
Submits a stock adjustment request (Increase or Decrease) for a given product barcode.
...
- Schema: `#/components/schemas/StockAdjustmentRequestDto`
