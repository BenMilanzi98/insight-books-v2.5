...
Types: Warehouse->Site, Site->Site.
...
## Purpose
Transfers inventory in bulk. Only one transfer type per request is allowed.
Types: Warehouse->Site, Site->Site.
...
- Schema: `#/components/schemas/InventoryTransferRequest`
