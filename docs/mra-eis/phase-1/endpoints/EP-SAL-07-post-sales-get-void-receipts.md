# EP-SAL-07: Retrieves void (cancelled receipt) requests.
...
## Purpose
Retrieves void (cancelled receipt) requests.
...
## Route
`/api/v1/sales/get-void-receipts`
...
- Schema: `#/components/schemas/VoidReceiptFilterDto`
