# EP-SAL-05: submits Sales Transaction
...
- Schema: `#/components/schemas/SalesInvoice`

## Response schema
- Declared HTTP responses: 200, 400, 401, 403, 500
...
OpenAPI HTTP codes: 200, 400, 401, 403, 500. Application error catalogue: ERROR_CODE_CATALOGUE.md + guide error_codes.
