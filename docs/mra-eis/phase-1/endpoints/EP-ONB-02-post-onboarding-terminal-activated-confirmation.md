...
by the terminal and device should be flagged as activated
...
## Purpose
Confirmation that the terminal activation response was fully processed 
by the terminal and device should be flagged as activated
...
- Schema: `#/components/schemas/ActivatedTerminalConfirmation`

## Response schema
- Declared HTTP responses: 200, 401, 500
...
OpenAPI HTTP codes: 200, 401, 500. Application error catalogue: ERROR_CODE_CATALOGUE.md + guide error_codes.
