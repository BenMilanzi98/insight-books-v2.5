# EP-UTL-07: Checks the status of a product as to where it ti mapped to UNSPSC at MRA side
...
## Purpose
Checks the status of a product as to where it ti mapped to UNSPSC at MRA side
...
- Schema: `#/components/schemas/ProductIdentifier`

## Response schema
- Declared HTTP responses: 200, 400, 404
...
OpenAPI HTTP codes: 200, 400, 404. Application error catalogue: ERROR_CODE_CATALOGUE.md + guide error_codes.
