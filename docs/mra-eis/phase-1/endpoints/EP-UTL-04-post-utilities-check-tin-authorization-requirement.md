# EP-UTL-04: Checks whether a TIN requires a purchase authorization code.
...
## Purpose
Checks whether a TIN requires a purchase authorization code.
...
- Schema: `#/components/schemas/TinAuthorizationRequirementRequest`
