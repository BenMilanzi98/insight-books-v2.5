# EP-STK-S1: Adds a new product to master products and creates zero-quantity warehouse inventory for the taxpayer.

**Access date:** 2026-07-22  
**Environment scope:** SANDBOX_ONLY (not in production OpenAPI)  
...
## Purpose
Adds a new product to master products and creates zero-quantity warehouse inventory for the taxpayer.
...
- Schema: `#/components/schemas/AddProductApiRequest`

## Response schema
- Declared HTTP responses: 200, 400, 401, 500
...
OpenAPI HTTP codes: 200, 400, 401, 500. Application error catalogue: ERROR_CODE_CATALOGUE.md + guide error_codes.
...
## Sources
- OpenAPI: docs/mra-eis/swagger-sandbox.v1.json
