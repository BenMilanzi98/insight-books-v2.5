...
`npx vitest run test/mraEis.phase14.fiscalReceipt.test.js` — 8/8 passed (contracts, URL security, QR resolve/generate/decode, receipt data/render, storage immutability, typed errors).
