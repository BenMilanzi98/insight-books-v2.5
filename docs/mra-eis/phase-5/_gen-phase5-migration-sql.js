/** Generates Phase 5 CREATE TABLE migration SQL (no DB required). */
import fs from 'fs';
import path from 'path';

const sql = `-- MRA EIS Phase 5 — operational persistence foundation
...
const out = path.resolve('prisma/migrations/20260722230000_mra_eis_phase5_foundation/migration.sql');
