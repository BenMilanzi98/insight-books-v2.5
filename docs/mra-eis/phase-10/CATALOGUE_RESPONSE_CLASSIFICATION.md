# Catalogue Response Classification

Outcomes in `CATALOGUE_RESPONSE_OUTCOME` including TERMINAL_BLOCKED, SITE/TIN mismatch, METHOD_REJECTED, UNCHANGED, EMPTY_VALID.
