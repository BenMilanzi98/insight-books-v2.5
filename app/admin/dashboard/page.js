      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-5 border-b border-gray-100 flex justify-between items-center">
            ...
            <button 
              onClick={() => router.push('/admin/dashboard/revenue-overview')}
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-5 border-b border-gray-100 flex justify-between items-center">
            ...
            <button 
              onClick={() => router.push('/admin/dashboard/subscription-growth')}
              className="text-sm text-indigo-600 flex items-center hover:text-indigo-800"
            >
              View Details <ChevronRight size={16} className="ml-1" />
            </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-5 border-b border-gray-100 flex justify-between items-center">
            ...
            <button 
              onClick={() => router.push('/admin/dashboard/subscription-analytics')}
              className="text-sm text-indigo-600 flex items-center hover:text-indigo-800"
            >
              View Details <ChevronRight size={16} className="ml-1" />
            </button>
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-5 border-b border-gray-100 flex justify-between items-center">
            ...
            <button 
              onClick={() => router.push('/admin/dashboard/system-performance')}
              className="text-sm text-indigo-600 flex items-center hover:text-indigo-800"
            >
              View Details <ChevronRight size={16} className="ml-1" />
            </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-5 border-b border-gray-100 flex justify-between items-center">
            ...
            <button 
              onClick={() => router.push('/admin/dashboard/user-analytics')}
              className="text-sm text-indigo-600 flex items-center hover:text-indigo-800"
            >
              View Details <ChevronRight size={16} className="ml-1" />
            </button>
        ...
        <div className="bg-white rounded-lg shadow">
          ...
          <div className="p-5">
            <div className="space-y-3">
              ...
              <button 
                onClick={() => router.push('/admin/dashboard/system-logs')}
                className="w-full flex items-center justify-between p-3 rounded-lg border border-gray-200 hover:border-indigo-300 hover:bg-indigo-50 transition-colors"
              >
                <div className="flex items-center">
