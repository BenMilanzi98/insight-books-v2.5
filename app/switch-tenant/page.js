    ...
    return (
      <div className="flex w-full items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">{tt('Loading your businesses...')}</p>
        </div>
      </div>
    );
  }
    ...
    <div className="w-full">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="mb-8 sm:mb-10">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">{tt('Your Businesses')}</h1>
          <p className="text-gray-600 text-sm sm:text-base">
            Switch between your businesses or create a new one. Owners and admins can{' '}
            <span className="font-medium text-gray-800">{tt('sync linked businesses')}</span> {tt('if some are missing from this list.')}
          </p>
        </div>
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center space-x-3 flex-1 min-w-0">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-xs sm:text-sm text-gray-500">{tt('Business')}</p>
                      </div>
                    </div>
                    {currentTenantId === tenant.id && (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 sm:p-6">
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between p-5 sm:p-6 border-b border-gray-200">
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900">{tt('Add New Business')}</h3>
              <button
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 sm:p-6">
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            <div className="flex items-center space-x-3 p-5 sm:p-6 border-b border-gray-200">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900">{tt('Delete Business')}</h3>
            </div>
            <div className="p-5 sm:p-6">
              <p className="text-gray-600 mb-5 sm:mb-6 text-sm sm:text-base leading-relaxed">
                {tt('Are you sure you want to delete')} <span className="font-semibold text-gray-900">{tenantToDelete.name}</span>? 
