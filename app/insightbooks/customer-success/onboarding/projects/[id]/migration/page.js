...
export default function OnboardingMigrationTabPage() {
  ...
  return (
    <div style={{ padding: '1.5rem', maxWidth: 720 }}>
      ...
      <h1 style={{ fontSize: '1.25rem', margin: '1rem 0 0.5rem' }}>Migration</h1>
      <p style={{ color: '#555' }}>
        Coordination states, private file inventory metadata, dry-run / recon gates. Upload alone ≠
        complete; <code>COMPLETED</code> rejected without reconciliation. Engine remains
        NOT_AVAILABLE until a real migration service is wired.
      </p>
    </div>
  );
}
