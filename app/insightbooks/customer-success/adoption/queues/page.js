...
export default function AdoptionQueuesPage() {
  return (
    <div style={{ padding: '1.5rem', maxWidth: 960 }}>
      ...
      <h1 style={{ fontSize: '1.5rem', marginBottom: '0.5rem' }}>{tt('Queues')}</h1>
      <p style={{ color: '#555', marginBottom: '1.25rem' }}>
        {tt('New requests, active / at-risk plans, value review. Counts via reliability gate — UNAVAILABLE / null on fail.')}
      </p>
