...
export default function CustomerSuccessAdoptionOutcomesPage() {
  return (
    <div style={{ padding: '1.5rem', maxWidth: 960 }}>
      ...
      <p style={{ color: '#555' }}>
        {tt('Time-to-first-value, feature activation, repeat-value signals with Phase 9 lineage. Missing analytics →')} <code>UNAVAILABLE</code> with{' '}
        <code>{tt('value: null')}</code> — never a false zero. Value review sign-off is
