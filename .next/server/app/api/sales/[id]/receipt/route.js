...
<div class="body">
  ...
  <div class="co-header">
    ${k.tenant.logoUrl?`<img src="${k.tenant.logoUrl.startsWith("http")?k.tenant.logoUrl:`http://162.35.99.177:3000${k.tenant.logoUrl}`}" alt="${k.tenant.name}" class="co-logo">`:`<div class="co-name">${k.tenant.name}</div>`}
        </div>
